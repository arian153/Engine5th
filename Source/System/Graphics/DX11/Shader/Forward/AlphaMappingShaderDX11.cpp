...
namespace Engine5
{
    AlphaMappingShaderDX11::AlphaMappingShaderDX11()
    {
    }
    ...
    void AlphaMappingShaderDX11::SetHWnd(HWND hwnd)
    {
        m_hwnd = hwnd;
    }

    void AlphaMappingShaderDX11::SetDevice(ID3D11Device* device)
    {
        m_device = device;
    }

    void AlphaMappingShaderDX11::SetDeviceContext(ID3D11DeviceContext* device_context)
    {
        m_device_context = device_context;
    }

    AlphaMappingShaderCommon::AlphaMappingShaderCommon(ShaderManagerCommon* shader_manager)
        : m_shader_manager(shader_manager)
    {
    }

    AlphaMappingShaderCommon::~AlphaMappingShaderCommon()
    {
    }

    void AlphaMappingShaderCommon::SetShader(ShaderResource* shader)
    {
        m_shader_resource = shader;
    }

    bool AlphaMappingShaderCommon::Initialize()
    {
    ...
    void AlphaMappingShaderCommon::Render(U32 indices_count, const MatrixData& mvp_data, TextureArrayCommon* texture, const Color& color) const
    {
    ...
    void AlphaMappingShaderCommon::Shutdown()
    {
