...
namespace Engine5
{
    ...
    bool InstanceBufferCommon::BuildBuffer(RendererCommon* renderer, const std::vector<ColorVertexCommon>& vertices, const std::vector<U32>& indices)
    {
    ...
    bool InstanceBufferCommon::BuildBuffer(RendererCommon* renderer, const std::vector<TextureVertexCommon>& vertices, const std::vector<U32>& indices)
    {
        m_device         = renderer->GetDevice();
        m_device_context = renderer->GetDeviceContext();
        // Set up the description of the static vertex buffer.
    ...
    bool InstanceBufferCommon::BuildBuffer(RendererCommon* renderer, const std::vector<NormalVertexCommon>& vertices, const std::vector<U32>& indices)
    {
        m_device         = renderer->GetDevice();
        m_device_context = renderer->GetDeviceContext();
        // Set up the description of the static vertex buffer.
    ...
    void InstanceBufferCommon::BuildInstanceBuffer(const std::vector<InstanceDataCommon>& instances)
    {
