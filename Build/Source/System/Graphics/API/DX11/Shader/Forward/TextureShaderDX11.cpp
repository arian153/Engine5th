...
namespace Engine5
{
    TextureShaderDX11::TextureShaderDX11()
    {
    }
    ...
    void TextureShaderDX11::SetHWnd(HWND hwnd)
    {
        m_hwnd = hwnd;
    }

    void TextureShaderDX11::SetDevice(ID3D11Device* device)
    {
        m_device = device;
    }

    void TextureShaderDX11::SetDeviceContext(ID3D11DeviceContext* device_context)
    {
        m_device_context = device_context;
    }

    TextureShaderCommon::TextureShaderCommon(ShaderManagerCommon* shader_manager)
        : m_shader_manager(shader_manager)
    {
    }

    TextureShaderCommon::~TextureShaderCommon()
    {
    }

    void TextureShaderCommon::SetShader(ShaderResource* shader)
    {
        m_shader_resource = shader;
    }

    bool TextureShaderCommon::Initialize()
    {
    ...
    void TextureShaderCommon::Render(U32 indices_count, const MatrixData& mvp_data, TextureCommon* texture, const Color& color) const
    {
    ...
    void TextureShaderCommon::Shutdown()
    {
