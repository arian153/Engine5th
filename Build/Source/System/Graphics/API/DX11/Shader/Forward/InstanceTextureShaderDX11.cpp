...
namespace Engine5
{
    InstanceTextureShaderDX11::InstanceTextureShaderDX11()
    {
    }
    ...
    void InstanceTextureShaderDX11::SetHWnd(HWND hwnd)
    {
        m_hwnd = hwnd;
    }

    void InstanceTextureShaderDX11::SetDevice(ID3D11Device* device)
    {
        m_device = device;
    }

    void InstanceTextureShaderDX11::SetDeviceContext(ID3D11DeviceContext* device_context)
    {
        m_device_context = device_context;
    }

    InstanceTextureShaderCommon::InstanceTextureShaderCommon(ShaderManagerCommon* shader_manager)
        : m_shader_manager(shader_manager)
    {
    }

    InstanceTextureShaderCommon::~InstanceTextureShaderCommon()
    {
    }

    void InstanceTextureShaderCommon::SetShader(ShaderResource* shader)
    {
        m_shader_resource = shader;
    }

    bool InstanceTextureShaderCommon::Initialize()
    {
        ...
        //world matrix
        //first
        polygon_layout[2].SemanticName         = "WORLD";
        ...
        //second
        polygon_layout[3].SemanticName         = "WORLD";
        ...
        //third
        polygon_layout[4].SemanticName         = "WORLD";
        ...
        //fourth
        polygon_layout[5].SemanticName         = "WORLD";
        ...
        //color
        polygon_layout[6].SemanticName         = "COLOR";
    ...
    void InstanceTextureShaderCommon::Render(U32 index_count, U32 instance_count, const MatrixData& mvp_data, TextureCommon* texture, const Color& color) const
    {
