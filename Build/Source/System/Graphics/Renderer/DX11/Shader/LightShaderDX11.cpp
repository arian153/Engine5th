...
namespace Engine5
{
    ...
    LightShaderCommon::LightShaderCommon(ShaderManager* shader_manager)
    ...
    void LightShaderCommon::Render(U32 indices_count, const Matrix44& world, const Matrix44& view, const Matrix44& proj, Camera* camera) const
    {
